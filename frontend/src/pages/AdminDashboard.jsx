        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
          ...
          >
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>
              My collaboratives, upcoming events, and recent evaluations
            </div>
          </button>
          ...
          >
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>
              One-off trainings not tied to a collaborative — manage rosters, materials, and the participant training hub
            </div>
          </button>
          ...
          >
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>
              Create public registration links and view rosters across all your collaboratives
            </div>
          </button>
