...
function Demographics() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to next assessment (dynamic based on program type)
      const programType = localStorage.getItem('sts_programType') || 'sts_bsc'
      navigate(getNextAssessmentPath(programType, 'demographics'))
      ...
      <div className="demographics-card">
        <div className="progress-bar">
          {(() => {
            ...
            const idx = getStepIndex(pt, 'demographics')
